...
docker build -t 002172820271.dkr.ecr.eu-west-1.amazonaws.com/auth:0.1.2 . 

### Run Docker Image locally & Test
docker run --name <name-of-container> -p 80:80 --rm -d <ECR-REPOSITORY-URI>:<TAG>
docker run --name auth -p 80:80 --rm -d 002172820271.dkr.ecr.eu-west-1.amazonaws.com/auth:0.1.2
...
docker push 002172820271.dkr.ecr.eu-west-1.amazonaws.com/auth:0.1.2
